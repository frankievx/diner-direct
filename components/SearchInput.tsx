...
const SearchInput = (props) => {
	...
	return (
		<div
			className="flex w-full py-2 px-2 bg-white shadow-sm rounded-lg 
      text-lg border border-solid border-gray-200 bg-transparent focus-within:border-primary 
      focus-within:border-solid focus-within:border hover:border-gray-500"
		>
